...
class PanaromaStitcher():
    ...
    def image_stitch(self, imageB,imageA, lowe_ratio=0.75, max_Threshold=4.0):
    ...
    def make_panaroma_for_images_in(self,path):
        ...
        result = self.image_stitch(images[no_of_images - 2], images[no_of_images - 1])
        for i in range(no_of_images-2):
            result = self.image_stitch(images[no_of_images - i - 3], result)
